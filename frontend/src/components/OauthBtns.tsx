...
const OauthBtns = ({ provider, method }: Props) => {
  const [loading, setLoading] = useState(false);
  const authType = provider === "github" ? "Github" : "Google";
  const methodType = method === "login" ? "Login" : "Signup";
      ...
      await authClient.signIn.social({
        ...
        fetchOptions: {
          ...
          onError: (cxt) => {
            ...
            toast.add({
              type: "error",
              description: cxt.error?.message || "Unknown error occurred",
              priority: "high",
            });
          },
        },
